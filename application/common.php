...
if (!function_exists('chaos_random_str')) {
    /**
     * 生成随机字符串
     * @param int $length 长度
     * @param int $mode 模式。0 包含字母数字和所有符号，1 包含字母，2 包含字母数字，3 包含字母数字和 _-
     * @return string
     */
    function chaos_random_str($length = 16, $mode = 2)
    {
...
if (!function_exists('chaos_password_crypt')) {
    /**
     * 密码加密
     * @param string $password 密码
     * @return string
     */
    function chaos_password_crypt($password)
    {
        $salt = '$2y$12$'. chaos_random_str(24);
        return crypt($password, $salt);
    }
}

if (!function_exists('chaos_password_check')) {
    /**
     * 密码检查
     * @param string $password 密码
     * @param string $hash 已加密的密码
     * @return bool
     */
    function chaos_password_check($password, $hash)
    {
...
if(!function_exists('chaos_dot_replace')) {
    /**
     * 改善半角逗号可读性
     * @param string $val 原始值
     * @return string|string[]
     */
    function chaos_dot_replace($val)
    {
